...
def terrain_levels_vel_y(
    ...
    move_up = distance > terrain.cfg.terrain_generator.size[1] / 2
    # print("==========================================")
    # print(f"Distance traveled: {distance}, threshold: {terrain.cfg.terrain_generator.size[1] / 2}")
